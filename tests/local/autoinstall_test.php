...
final class autoinstall_test extends \advanced_testcase {
     ...
     *
     * @covers \archivingmod_quiz\local\autoinstall::execute
     *
     * @return void
     */
    ...
    public function test_autoinstall(): void {
        ...
        // Check worker URL.
        $this->assertSame($workerurl, get_config('archivingmod_quiz', 'worker_url'), 'Worker URL was not set correctly');
        ...
        $this->assertSame(
            $webservice->id,
            get_config('archivingmod_quiz', 'webservice_id'),
        ...
        $this->assertSame($user->id, get_config('archivingmod_quiz', 'webservice_userid'), 'User ID was not set correctly');
     ...
     * are prevented.
     *
     * @covers \archivingmod_quiz\local\autoinstall::plugin_is_unconfigured
     * @covers \archivingmod_quiz\local\autoinstall::execute
     *
     * @return void
     * @throws \dml_exception
